<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"C:\Users\Administrator\Desktop\tpbt\public/../application/admin\view\index\index.html";i:1552012172;s:75:"C:\Users\Administrator\Desktop\tpbt\application\admin\view\common\head.html";i:1552012172;s:75:"C:\Users\Administrator\Desktop\tpbt\application\admin\view\common\foot.html";i:1552012172;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>NMCT后台管理</title>
    ...
    <div class="layui-main">
        <div class="admin-login-box">
            <a class="logo" style="left: 0;" href="<?php echo url('admin/index/index'); ?>">
                <span style="font-size: 22px;color:#fff">NMCT</span>
            </a>
        ...
        <ul class="layui-nav admin-header-item">
            ...
            <li class="layui-nav-item">
                <a href="javascript:;" class="admin-header-user">
                    <img src="/static/admin/images/0.jpg" />
...
<div class="layui-body" id="admin-body">
    ...
    <div class="layui-footer footer footer-demo" id="admin-footer">
        <div class="layui-main">
            <p>2017 &copy;
                <a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/"><?php echo $_SERVER['HTTP_HOST'];?></a> LGPL license
            </p>
        </div>
    </div>
