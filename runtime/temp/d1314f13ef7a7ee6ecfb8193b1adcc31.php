                ...
                <table class=" layui-table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           <?php if($v['level_id'] > 9): ?> <a href="javascript:;" onclick="return del('<?php echo $v['level_id']; ?>')" class="layui-btn layui-btn-mini layui-btn-danger"><?php echo lang('del'); ?></a><?php endif; ?>
                        </td>
                    </tr>
